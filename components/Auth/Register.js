    ...
    <div className="h-screen bg-blue-500 fixed top-0 left-0 bottom-0 right-0 z-40 flex justify-center items-center">
      <div className="bg-white h-auto w-11/12 rounded-lg relative shadow-2xl md:max-w-sm md:mx-auto">
        ...
        <div className="text-center m-3 mt-10 font-san">
          <b className="text-xl text-gray-900">Register An Account</b> <br />
          <span className="text-sm text-gray-400">Fill in your details below to create an account</span>
        ...
        <form className="w-11/12 mx-auto flex flex-col justify-center items-center my-10" onSubmit={handleSubmit}>
         {/* Email */}
          ...
          {/* Submit */}
          <button type="submit" className="my-3 bg-blue-500 focus:outline-none text-white p-3 w-11/12 rounded-md shadow-xl hover:shadow-none">Create Account</button>
          ...
          >
            <i className="la la-google-plus text-blue-500 text-3xl absolute left-5"></i> Signup With Google
          </div>

          {/* Login */}
          <div className="my-4">
            <div onClick={() => router.push('/login')} className="hover:underline text-blue-500 text-sm font-sans text-center cursor-pointer">Already have an account? Login</div>
          </div>
        </form>
      </div>
